...
6.  In the **Microsoft Azure Storage Tools – v8.0.0-notcorepreview Setup** dialog box, on the **Welcome to the Microsoft Azure Storage Tools – v8.0.0-netcorepreview Setup Wizard** page, click **Next**.
...
9.  On the **Ready to install Microsoft Azure Storage Tools – v8.0.0-notcorepreview** page, click **Install**.
10. In the **User Account Control** dialog box, click **Yes**.
11. On the **Completed the Microsoft Azure Storage Tools – v8.0.0-notcorepreview Setup Wizard** page, click **Finish**.
...
1.  In the Azure portal, click **+ Create a resource**, then in the **Search marketplace** box, type **sql server**, and then click **SQL server (logical server)**.
...
6.  The **Allow azure services to access server** check box is selected by default.
...
7.  Click **Performance level**
8.  One the **Configure performance** page, click **Gen1**
